...
var GameScene = BaseScene.extend({
    ...
    onEnter: function () {
        ...
        //cc.AudioEngine.getInstance().preloadSound(a_Zombie_Mp3);
                                 ...
                                 cc.AudioEngine.getInstance().playMusic(a_Zombie_Mp3,true);
        cc.AudioEngine.getInstance().playMusic(a_BKMusic_Mp3,true);
...
/*        var layer = GameLayer.create(new cc.Color4B(0,0,255,40));
        ...
        this.cutSprite = cc.Sprite.create(s_cut_png, cc.rect(0, 0, 143, 102));
        this.cutSprite.setOpacity(0);
        this.cutSprite._setZOrder(10000);
        this.cutSprite.setScaleX(-0.5);
        this.cutSprite.setScaleY(0.5);
                                 this.cutSprite.setAnchorPoint(cc.p(0.5,0.5));//(0.5, 0.5);
...
/*
        ...
        if(this.winLayer && this.winLayer.init(cc.c4b,9))
                                 {
                                 this.addChild(this.winLayer, 20000);
                                 }
